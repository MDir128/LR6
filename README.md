...
3) Создаем новую ветку, в ней файл, а затем высылаем это в репозиторий на гитхаб

![](screenshots/op2.png)

![](screenshots/op3.png)

4) Получаем историю коммитов ветки ex

![](screenshots/op4.png)

6) получаем историю коммитор ветки master

![](screenshots/op5.png)

6) После создания одновременных файлов в разных ветках, как разных так и одновременных, а потом и заполнения одного и того-же файла в разных ветках противоречивой информацией, конфликтов не произошло и git автоматически выбирал версию из master, потому на скриншоте только схематическое изображение коммитов

![](screenshots/op9.png)

8) Была создана серия коммитов с тремя разными файлами
...
10) Был отменен предыдущий коммит (в результате чего git удалил новодобавленный файл), после чего новый коммит фактически отменил предыдущий

![](screenshots/op10.png)

12) Получили красивый вид лога коммитов

![](screenshots/op11.png)

14) Наконец сделал конфликто
